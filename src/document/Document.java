...
public abstract class Document {
    ...
    protected int countSyllables(String word) {
		...
		if (word.length() == 1 && (word.equalsIgnoreCase("a") || word.equalsIgnoreCase("e") ||
			...
			for (int i = 0; i < word.length() - 1; i++) {
				if ((word.charAt(i) == 'a' || word.charAt(i) == 'e' || word.charAt(i) == 'i'
						...
						|| word.charAt(i) == 'y') && (word.charAt(i + 1) != 'a'
						&& word.charAt(i + 1) != 'e' && word.charAt(i + 1) != 'i' && word.charAt(i + 1)
						!= 'o' && word.charAt(i + 1) != 'u' && word.charAt(i + 1) != 'y')) {
					count++;
				}
			}
			if (count == 0 && (word.charAt(word.length() - 1) == 'e')
    ...
    public double getFleschScore() {
        ...
        double flesch = 206.835 - 1.015 * (numWords / numSentences) - 84.6 * (numSyllables / numWords);
        return (double) Math.round(flesch * 1000d) / 1000d;
    }
